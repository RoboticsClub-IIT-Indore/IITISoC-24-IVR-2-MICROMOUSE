...
def isAccessible(x,y,x1,y1):
     ...
     if (x==x1):
        if(y>y1):
            if(cells[y][x]== 4 or 5 or 6 or 10 or 11 or 12 or 14 , cells[y1][x1]== 2 or 7 or 8 or 10 or 12 or 13 or 14):
                return(False)
            else:
                return(True)
        else:
            if(cells[y][x]== 2 or 7 or 8 or 10 or 12 or 13 or 14 , cells[y1][x1]==  4 or 5 or 6 or 10 or 11 or 12 or 14):
                return(False)
            else:
                return(True)
         ...
         if(x>x1):
             if(cells[y][x]== 1 or 5 or 8 or 9 or 11 or 13 or 14 , cells[y1][x1]== 3 or 6 or 7 or 9 or 11 or 12 or 13):
                 return(False)
             else:
                 return(True)
         else:
             if(cells[y][x]== 3 or 6 or 7 or 9 or 11 or 12 or 13 , cells[y1][x1]== 1 or 5 or 8 or 9 or 11 or 13 or 14):
                 return(False)
             else:
                 return(True)
